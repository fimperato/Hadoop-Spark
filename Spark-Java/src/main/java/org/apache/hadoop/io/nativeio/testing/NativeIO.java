 ...
 */
package org.apache.hadoop.io.nativeio.testing;
...
/**
 * It could do error while trying to run a minicluster.
 * What I did to overcome this is to create my own NativeIO and override the access method to always return true -
 * and make sure it loads before the hadoop libs.
 *
 */
