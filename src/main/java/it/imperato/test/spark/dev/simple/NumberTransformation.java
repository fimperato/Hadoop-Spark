...
/**
 *
 * %spark_home%/bin/spark-submit --class it.imperato.test.spark.dev.simple.NumberTransformation --master local[1] C:\wsIdea\Spark_2018\SparkJava\target\spark-java.jar
 *
