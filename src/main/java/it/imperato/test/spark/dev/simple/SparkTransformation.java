...
/**
 *
 * %spark_home%/bin/spark-submit --class it.imperato.test.spark.dev.simple.SparkTransformation --master local[1] C:\wsIdea\Spark_2018\SparkJava\target\spark-java.jar /input.txt /output-dir
 *
 */
